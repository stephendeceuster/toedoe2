...
var _default = thunk;
exports.default = _default;
},{}],"redux/todoList.js":[function(require,module,exports) {
"use strict";
...
const CHECK_TODO = "CHECK_TODO"; //ACTION CREATORS
...
const todoListReducer = (state = initialState, {
  type,
  payload
}) => {
  switch (type) {
...
const store = (0, _redux.createStore)(_todoList.default, (0, _redux.applyMiddleware)(_reduxLogger.default, _reduxThunk.default));
var _default = store;
exports.default = _default;
},{"redux":"../../node_modules/redux/es/redux.js","redux-logger":"../../node_modules/redux-logger/dist/redux-logger.js","redux-thunk":"../../node_modules/redux-thunk/es/index.js","./todoList":"redux/todoList.js"}],"components/ToDoList.js":[function(require,module,exports) {
"use strict";
...
var _todoList = require("../redux/todoList");
...
class ToDoList {
  ...
  setupEvents = () => {
    this._formRef.addEventListener("submit", e => {
      ...
      _store.default.dispatch((0, _todoList.addToDo)(this._inputRef.value));
...
var _default = holder => new ToDoList(holder);

exports.default = _default;
},{"../redux/store":"redux/store.js","../redux/todoList":"redux/todoList.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
const appRef = document.querySelector('.todoApp');
(0, _ToDoList.default)(appRef);
},{"./../../icons/svgxuse":"../../icons/svgxuse.js","./components/ToDoList":"components/ToDoList.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
